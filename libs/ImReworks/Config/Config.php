...
use ImReworks\Config\ConfigException as Config_Exception;
...
class Config implements Countable, Iterator
{
    ...
    /**
     * Set an extend for Config_Writer
     *
    ...
    protected function _assertValidExtend($extendingSection, $extendedSection)
    {
        ...
        while (array_key_exists($extendedSectionCurrent, $this->_extends)) {
            if ($this->_extends[$extendedSectionCurrent] == $extendingSection) {
                /** @see Config_Exception */
                throw new Config_Exception('Illegal circular inheritance detected');
            }
