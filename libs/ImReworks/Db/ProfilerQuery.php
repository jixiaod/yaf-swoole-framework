...
class ProfilerQuery
{
    ...
    /**
     * One of the Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the Profiler::* constants)
     *
     * @return integer
     */
