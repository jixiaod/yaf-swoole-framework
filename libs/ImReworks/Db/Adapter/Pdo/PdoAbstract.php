...
abstract class PdoAbstract extends AdapterAbstract
{
     ...
     * @var string
     */
    protected $_defaultStmtClass = '\ImReworks\Db\Statement\Pdoi';
    ...
    protected function _connect()
    {
        ...
        $q = $this->_profiler->queryStart('connect', \ImReworks\Db\Profiler::CONNECT);
     ...
     *
     * @param string|IR_Db_Select $sql The SQL statement with placeholders.
     * @param array $bind An array of data to bind to the placeholders.
     * @return ImReworks\Db\Statement\Pdoi
     * @throws AdapterException To re-throw PDOException.
     */
    public function query($sql, $bind = array())
    {
        if (empty($bind) && $sql instanceof IR_Db_Select) {
            $bind = $sql->getBind();
        }
