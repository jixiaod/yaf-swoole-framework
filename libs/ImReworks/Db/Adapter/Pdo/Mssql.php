...
class Mssql extends PdoAbstract
{
    /**
     * PDO type.
     *
    ...
    protected $_numericDataTypes = array(
        ...
        'MONEY'              => IR_Db::FLOAT_TYPE,
        'NUMERIC'            => IR_Db::FLOAT_TYPE,
        'REAL'               => IR_Db::FLOAT_TYPE,
        'SMALLMONEY'         => IR_Db::FLOAT_TYPE
    );
    ...
    public function describeTable($tableName, $schemaName = null)
    {
        ...
        $stmt = $this->query($sql);
        $primaryKeysResult = $stmt->fetchAll(IR_Db::FETCH_NUM);
