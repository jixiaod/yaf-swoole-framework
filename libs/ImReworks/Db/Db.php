...
use ImReworks\Db\Adapter\AdapterAbstract;

class Db
{

    /**
     * Use the PROFILER constant in the config of a ImReworks\Db\Adapter.
     */
    const PROFILER = 'profiler';

    /**
     * Use the CASE_FOLDING constant in the config of a ImReworks\Db\Adapter.
     */
    const CASE_FOLDING = 'caseFolding';

    /**
     * Use the FETCH_MODE constant in the config of a ImReworks\Db\Adapter.
     */
    const FETCH_MODE = 'fetchMode';

    /**
     * Use the AUTO_QUOTE_IDENTIFIERS constant in the config of a ImReworks\Db\Adapter.
     */
    const AUTO_QUOTE_IDENTIFIERS = 'autoQuoteIdentifiers';

    /**
     * Use the ALLOW_SERIALIZATION constant in the config of a ImReworks\Db\Adapter.
     */
    const ALLOW_SERIALIZATION = 'allowSerialization';

    /**
     * Use the AUTO_RECONNECT_ON_UNSERIALIZE constant in the config of a ImReworks\Db\Adapter.
     */
    ...
    /**
     * Factory for AdapterAbstract classes.
     *
     * First argument may be a string containing the base of the adapter class
     * name, e.g. 'Mysqli' corresponds to class ImReworks\Db\Adapter_Mysqli.  This
     ...
     *
     * First argument may alternatively be an object of type Config.
     ...
     *
     * If the first argument is of type Config, it is assumed to contain
     * all parameters, and the second argument is ignored.
     *
     * @param  mixed $adapter String name of base adapter class, or Config object.
     * @param  mixed $config  OPTIONAL; an array or Config object with adapter parameters.
    ...
    public static function factory($adapter, $config = array())
    {
        ...
        /*
         * Convert Config argument to plain string
         * adapter name and separate config object.
         */
        if ($adapter instanceof ImReworks\Config\Config) {
        ...
        if (!is_array($config)) {
             ...
             * @see DbException
             */
            throw new DbException('Adapter parameters must be in an array or a Config object');
        }
         ...
         */
        $adapterNamespace = 'ImReworks\Db\Adapter';
        ...
        $adapterName .= str_replace(' ', "\\", ucwords(str_replace('_', ' ', strtolower($adapter))));
        ...
        if (! $dbAdapter instanceof AdapterAbstract) {
             ...
             * @see DbException
             */
            throw new DbException("Adapter class '$adapterName' does not extend AdapterAbstract");
        }
