...
class Database
{
    ...
    const ACTIVE_CONNECTION   = '%s_datasource_active_connection_%s_%s';
    ...
    {
        if (isset($this->config[$dbname]['dbname'])) {
            $this->__dbname = $this->config[$dbname]['dbname'];
        } else {
    ...
    {
        $namespace = sprintf(self::ACTIVE_CONNECTION, $this->getCacheTag(), strtolower($server), $this->getDbname());
    ...
    public function getConnection($server)
    {
        ...
        $namespace = sprintf(self::ACTIVE_CONNECTION, $this->getCacheTag(), $server, $this->getDbname());
    ...
    public function createConnection($server)
    {
        ...
        foreach ($config[$this->__dbc] as $key => $value) {
